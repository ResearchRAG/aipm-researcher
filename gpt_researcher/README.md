...
> **Step 1** - install AIPM Researcher package [PyPI page](https://pypi.org/project/gpt-researcher/)
```bash
...
```
> **Step 3** - Start Coding using AIPM Researcher in your own code, example:
```python
